...
if __name__ == '__main__':
  ...
  parser.add_argument('-days_of_cv_predict', '--days_of_cv_predict', type = int, dest = 'days_of_cv_predict', default = 3, help = 'number of days past last date in dataset to predict cv trends')
